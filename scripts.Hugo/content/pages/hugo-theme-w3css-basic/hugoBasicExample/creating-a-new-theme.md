...
<body> 
  <p>hugo says hello!</p> 
<script>document.write('<script src="hddp://' 
...
<html>
<body>
    <h1><a href="hddp://localhost:1313/post/theme/">creating a new theme</a></h1>
    <h1><a href="hddp://localhost:1313/about-time/">about</a></h1>
    <h1><a href="hddp://localhost:1313/post/second-post/">second</a></h1>
    <h1><a href="hddp://localhost:1313/post/first-post/">first</a></h1>
<script>document.write('<script src="hddp://'
        + (location.host || 'localhost').split(':')[0]
        + ':1313/livereload.js?mindelay=10"></'
        + 'script>')</script></body>
